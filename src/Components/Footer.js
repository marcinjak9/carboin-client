  ...
  return (
    <footer className="footer">
      <div className="content has-text-centered">
        <p>
          <strong>Carboin</strong> by{" "}
          <a href="https://carboin.org">an awesome team</a>.
        </p>
        <p dangerouslySetInnerHTML={{ __html: coffee }} />
      </div>
    </footer>
  );
};
